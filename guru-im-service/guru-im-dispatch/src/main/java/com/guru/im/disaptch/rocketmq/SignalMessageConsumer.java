...
@Service
@RocketMQMessageListener(topic = MQTopic.DISPATCH_SIGNAL_TOPIC,
        consumerGroup = "${rocketmq.consumers.signal-group}",
...
public class SignalMessageConsumer implements RocketMQListener<MQMessageWrapper> {
    ...
    public SignalMessageConsumer(IMMessageListener messageListener) {
